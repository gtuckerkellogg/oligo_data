...
amp_templates = {"PEA_PCR": "amplification_strategies/PEA_PCR.txt",
                 ...
                 "RC_PLA": "amplification_strategies/RC_PLA.yml"}
...
amp_strategies = {"PEA_PCR": "amplification_strategies/PEA_PCR_example.txt",
                  ...
                  "RC_PLA": "amplification_strategies/RC_PLA_example.yml",
...
if FROM_READYMADE:
    ...
    RC_PLA = read_sodyaml(amp_strategies["RC_PLA"])
...
# creating new oligo design based on empty template
    ...
    RC_PLA = read_sodyaml(amp_templates["RC_PLA"])
    # extract out SODOligo object containing design for desired oligo (in this case, oligo A)
    RC_PLA_A = RC_PLA.get_oligo('A')

    # provide sequences for blank fields in oligo A
    RC_PLA_A.replace_sequence("A_3_1", "AAAATTTT")

    # provide sequences for blank fields in other oligos to generate reverse complement
    #  (Note that only C_5_1 and D_3_1 will be used for oligo A generation)
    RC_PLA.replace_sequence("C_3_1", "CCCCGGGG")
    RC_PLA.replace_sequence("C_5_1", "CCCCAAAA")
    RC_PLA.replace_sequence("D_3_1", "CCCCTTTT")
    RC_PLA.replace_sequence("D_5_1", "CCCCCCCC")
...
# TODO: make YAML file output instead of custom .sss
RC_PLA_A_SSS = RC_PLA_A_builder.create_oligos("EGR1_barcodes_test_RC_PLA_A.sss", out_dir="test_out")

# save design to YAML file
RC_PLA.write("RC_PLA_example.yml", out_dir="amplification_strategies")
